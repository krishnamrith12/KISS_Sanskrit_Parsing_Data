...
from utils.models.parsing_gating_layers import BiAffine_Parser_Gated
...
def read_arguments():
    ...
    args_.add_argument('--multi_task_layers', type=int, nargs='+', default = [0, 1, 2, 3, 4], help='MultiTask Layers to use in dep parser')
    ...
    args_dict['multi_task_layers'] = args.multi_task_layers
...
def build_model_and_optimizer(args, ner_model=None):
    ...
    model = BiAffine_Parser_Gated(args.word_dim, args.num_word, args.char_dim, args.num_char,
                            ...
                            layers_to_use=args.multi_task_layers)
