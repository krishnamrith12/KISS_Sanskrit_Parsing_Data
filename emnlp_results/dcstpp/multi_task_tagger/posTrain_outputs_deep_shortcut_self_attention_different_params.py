...
from model.mtl_deep_shortcut_self_attention_different_params import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--char_hidden', type=int, default=64, help='dimension of char-level layers')
    ...
    parser.add_argument('--out_files', nargs='+', default='./data/ner2003/eng.train.iobes', help='Apply output annotation to files. Should be in the same order as the pkl file order')
