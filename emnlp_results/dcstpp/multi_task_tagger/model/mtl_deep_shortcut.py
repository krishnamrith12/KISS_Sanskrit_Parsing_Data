...
class LM_LSTM_CRF(nn.Module):
    ...
    def forward(self, forw_sentence, forw_position, back_sentence, back_position, word_seq, file_no, hidden=None, return_lstm_outputs_only=True):
        '''
        args:
        ...
        for i in range(file_no + 1):
            ...
            all_lstm_outputs.append(self.dropout(lstm_output))
            prev_lstm_output = lstm_output

        if return_lstm_outputs_only:
            return all_lstm_outputs
