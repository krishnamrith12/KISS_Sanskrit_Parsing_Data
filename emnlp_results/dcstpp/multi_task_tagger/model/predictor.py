        ...
        for d_ind in tqdm( range(0, d_len), mininterval=1,
            ...
            for ind in range(0, f_len, self.batch_size):
                ...
                for ind2 in range(ind, eind):
                    ...
                    fout.write('\n')
        print('Number of unks : ' + str(self.count_unks))
...
class predict_wc(predict):
    ...
    def apply_model(self, ner_model, features, file_no, only_return_ids=False):
        """
        ...
        for wf in word_features:
            self.count_unks += sum(x == 0 for x in wf)
        ...
        if only_return_ids:
            return f_f, f_p, b_f, b_p, w_f, file_no
    ...
    def encode_sentences(self, features, file_no):
        """
        apply_model function for LM-LSTM-CRF
        ...
        return f_f, f_p, b_f, b_p, w_f, mask_v, file_no
