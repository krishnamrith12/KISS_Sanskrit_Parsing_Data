...
class BiAffine_Parser_Gated(nn.Module):
    def __init__(self, word_dim, num_words, char_dim, num_chars, use_pos, use_char, pos_dim, num_pos, num_filters,
                 ...
                 biaffine=True, arc_decode='mst', initializer=None, ner_model=None, project_ner_model=True, ner_model_separate_projections=True, freeze_ner_model=True, layers_to_use=[0, 1, 2, 3, 4]):
